...
public class TypeConverter {
  ...
  public static <T> T convertToPrimitiveWrapper(@NotNull Class<T> targetType, @NotNull String value) {
    if (!isWrapperType(targetType)) {
      throw new IllegalArgumentException("The provided type should be a wrapper of primitive");
    }
  ...
  @NotNull
  public static Object convert(@NotNull Class<?> targetType, @NotNull String value) {
