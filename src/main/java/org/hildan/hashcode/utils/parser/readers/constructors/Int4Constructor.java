...
/**
 * Stands for a constructor with 4 int arguments. It can be used as an {@link ObjectReader} that reads 4 integers from
 ...
 */
public interface Int4Constructor<T> extends ObjectReader<T> {
