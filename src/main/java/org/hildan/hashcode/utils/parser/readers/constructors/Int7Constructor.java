...
/**
 * Stands for a constructor with 7 int arguments. It can be used as an {@link ObjectReader} that reads 7 integers from
 ...
 */
@FunctionalInterface
public interface Int7Constructor<T> extends ObjectReader<T> {
